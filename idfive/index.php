    ...
    <main class="clear">
      <div class="video-bubble hero halfway-section">
        ...
        </div><img src="http://localhost/wordpress/wp-content/uploads/2018/07/hero.jpg" alt="undefined">
      </div>
      <ul class="swift-slide product-slide halfway-section">
        <li class="hero product">
          ...
          </div><img src="http://localhost/wordpress/wp-content/uploads/2018/07/honeywell.jpg" alt="undefined">
        </li>
        <li class="hero product">
          <div class="compartment">
            <div class="product__details">
      ...
      <div class="halfway-section">
        <ul class="partners">
          ...
          <li class="partners__item"><a href=""><img src="http://localhost/wordpress/wp-content/uploads/2018/07/descartes.png" alt="undefined"></a></li>
          <li class="partners__item"><a href=""><img src="http://localhost/wordpress/wp-content/uploads/2018/07/honeywell.png" alt="undefined"></a></li>
          <li class="partners__item"><a href=""><img src="http://localhost/wordpress/wp-content/uploads/2018/07/nicelabel.png" alt="undefined"></a></li>
          <li class="partners__item"><a href=""><img src="http://localhost/wordpress/wp-content/uploads/2018/07/intellitrack.png" alt="undefined"></a></li>
          <li class="partners__item"><a href=""><img src="http://localhost/wordpress/wp-content/uploads/2018/07/zebra.png" alt="undefined"></a></li>
        </ul>
        <div class="bubble bubble--big bubble--white">
          <div class="compartment">
            <div class="blockquote-bubble clear">
                <figure class="shifted-asset shifted-asset--left"><img src="http://localhost/wordpress/wp-content/uploads/2018/07/big-circle.jpg" alt="">
          ...
          <div class="grid">
            ...
            <div class="col-flush">
              <div class="callout callout--dark-blue callout--featured"><a href="" class="callout__details">
                  ...
                  <div class="callout__logo"><img src="http://localhost/wordpress/wp-content/uploads/2018/07/honeywell-white.png" alt="undefined">
                  </div>
        ...
        <div class="social-feeds">
          <div class="compartment">
            <ul>
              ...
              <li><a href="" target="_blank"><img src="http://localhost/wordpress/wp-content/uploads/2018/07/geeknetwork.png" class="full-width"></a></li>
            </ul>
          </div>
        </div>
        <div class="sign-up">
